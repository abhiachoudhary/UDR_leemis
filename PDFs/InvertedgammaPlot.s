...
alpha = 1
beta = 1
f = ((beta^alpha)/(gamma(alpha)))*(x^(-alpha-1))*(exp(-1/(beta*x)))

postscript(file = "InvertedgammaPlot.ps", width = 4.0, height = 3.0, horizontal = F)
...
# alpha = 1, beta = 1
text(2.5, 0.2, "lab1", cex = 0.7, adj = 0, font = 3)

# alpha = 1.5, beta = 1
text(0.9, 0.7, "lab2", cex = 0.7, adj = 0, font = 3)

text(5.4, -0.0666, "labx", cex = 0.7, adj = 0, font = 3)
