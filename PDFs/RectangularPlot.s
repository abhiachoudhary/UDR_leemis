x = 0:5
f = c(1/6,1/6,1/6,1/6,1/6,1/6) 

postscript(file = "RectangularPlot.ps", width = 4.0, height = 3.0, horizontal = F)
...
text(5.3, -0.0045, "labx", cex = 0.7, adj = 0, font = 10)
text(-.5, 0.195, "labf", cex = 0.7, adj = 0, font = 10)
text(-1, 0.1667, "labff", cex = 0.7, adj = 0, font = 10)
