...
postscript(file = "TriangularPlot.ps", width = 4.0, height = 3.0, horizontal = F)
...
axis(side = 1, ticks = T, labels = F, at = c(0, 1, 3), font.axis = 3, cex.axis = 0.95)
axis(side = 2, ticks = T, labels = F, at = c(0, 2 / 3), font.axis = 3, cex.axis = 0.95)
