...
postscript(file = "StandardtriangularPlot.ps", width = 4.0, height = 3.0, horizontal = F)
...
axis(side = 1, ticks = T, labels = T, at = c(-1, 0, 1), font.axis = 3, cex.axis = 0.95)
axis(side = 2, ticks = T, labels = T, at = c(0, 1), font.axis = 3, cex.axis = 0.95)
...
#  text(1.5, -0.123, "labm", cex = 0.7, adj = 0, font = 10)
#  text(3, -0.123, "labb", cex = 0.7, adj = 0, font = 10)

text(1.19, -0.045, "labx", cex = 0.7, adj = 0, font = 10)
text(-1.20, 1.11, "labf", cex = 0.7, adj = 0, font = 10)
