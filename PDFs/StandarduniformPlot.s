...
postscript(file = "StandarduniformPlot.ps", width = 4.0, height = 3.0, horizontal = F)
...
axis(side = 1, ticks = T, labels = T, at = c(0, 1), font.axis = 3, cex.axis = 0.95)
...
text(1.07, -0.028, "labx", cex = 0.7, adj = 0, font = 10)
text(-0.10, 1.09, "labf", cex = 0.7, adj = 0, font = 10)
